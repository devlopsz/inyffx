(function () {
  ...
  window.INYFFX_REGISTRATION_QUESTIONS = [
    ...
    q("gameTitle", "CARREIRA", "Em qual jogo essa carreira acontece?", "select", { required: true, options: ["EA SPORTS FC", "eFootball / PES", "Football Manager", "Outro"] }),
    q("platform", "CARREIRA", "Em qual plataforma você joga?", "select", { options: ["PC", "PlayStation 5", "PlayStation 4", "Xbox Series X|S", "Xbox One", "Nintendo Switch", "Outro"] }),
    q("season", "CARREIRA", "Qual é a temporada atual do save?", "text", { required: true, placeholder: "2026/27" }),
    ...
    q("backstory", "NARRATIVA", "Conte resumidamente a história dele antes do início do RPG.", "textarea", { required: true, maxLength: 3000, placeholder: "Origem, dificuldades, momentos marcantes, motivação e relação com o futebol." }),
